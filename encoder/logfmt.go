...
// Logfmt is a log encoder for machine and human-readable logs, it follows the
// logfmt "standard" first documented by [Brandur Leach](https://brandur.org/logfmt).
// This encoder is designed for both development and production where logs may
// need to be read by both humans and log aggregation systems, it's a middle
...
func (e *Logfmt) Provision() error {
	e.CallerFormat = "long"
	e.LevelFormat = "lower"
	e.TimeFormat = "rfc3339"

	e.Encoder = newLogfmtEncoder(e.Config.ZapcoreEncoderConfig())
	return nil
}
